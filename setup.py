...
system("yay -S --needed partitionmanager sddm-archlinux-theme-git firewalld buildah podman brave-bin dolphin ark konsole jre17-openjdk brave-bin sweeper kcalc kmousetool  filelight plasma-systemmonitor prismlauncher-bin lapce-nightly-bin megasync-bin timeshift visual-studio-code-bin " + n)
