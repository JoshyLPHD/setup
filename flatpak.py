...
system(s+"flatpak install flathub com.github.marhkb.Pods")
system(s+"flatpak install flathub org.gabmus.whatip")
system(s+"flatpak install flathub com.boxy_svg.BoxySVG")
