...
system(s+xi+ "flatpak plasma-firewall ufw dolphin sl sddm gcc konsole timeshift partitionmanager filelight pulseaudio dbus xorg kde5 zsh wget curl nano zsh-autosuggestions htop -y")
