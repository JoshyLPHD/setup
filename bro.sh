...
eval "yay -Syu   $n"
eval "yay -S $nn wayland wayland-protocols flatpak qbittorrent lutris obs-studio xorg-xwayland gimp steam discord wayland-utils inetutils fusepak blueman bluez  jdk17-openjdk partitionmanager firewalld dolphin ark konsole jre17-openjdk kcalc plasma-systemmonitor timeshift-bin   $n"
