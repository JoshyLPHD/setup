...
eval "yay -Syu   $n"
eval "yay -S $nn wayland git neofetch xorg plasma ttf-liberations cmake egl-wayland podman  vscodium-bin mesa go mkinitcpio prismlauncher-bin plasma-wayland-session nano sl discord dbus sddm htop base-devel  wget curl make gcc jdk8-openjdk steam zsh wayland-protocols xorg-xwayland  wayland-utils inetutils fusepak blueman bluez  jdk17-openjdk partitionmanager firewalld neofetch dolphin ark konsole jre17-openjdk kcalc plasma-systemmonitor timeshift-bin   $n"
